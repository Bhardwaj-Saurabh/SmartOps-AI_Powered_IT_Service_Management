...
class PromptCfg(BaseModel):
    narrative_system_path: str
    narrative_user_path: str


class SemanticQueries(BaseModel):
    sla_targets: str
    business_hours: str
    sla_business_hours_only: str
    sla_pause_conditions: str
    sla_breach_warning_pct: str
...
class AgentConfig(BaseModel):
    ...
    narrative: NarrativeCfg = NarrativeCfg()
    audit: AuditCfg
    kpis: KPIsCfg
